...
pub use stress_recovery::{
    ...
    interpolate_element_displacement, interpolate_quad_displacement, interpolate_triangle_displacement,
    interpolate_truss_displacement, recover_beam_response, recover_beam_section_response, recover_element_response,
    recover_model_responses, recover_quad_response, recover_quad_responses, recover_triangle_response,
